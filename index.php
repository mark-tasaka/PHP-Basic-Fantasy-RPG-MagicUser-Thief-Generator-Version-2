...
<html>
<head>
<title>Launch Page: Magic-User/Thief Character Generator Basic Fantasy RPG</title>
...
<body>
	...
	<section>
		...
		<h1><img src="launchPage/images/title.png" alt="Magic-User/Thief Character Generator Basic Fantasy RPG" class="image" /></h1>
		...
		<form action="" id ="ThiefMagicFormV3"  target="_blank" method="post">
...
<option value="1" selected>1st Level, ThiefMagic</option>
<option value="2">2nd Level, ThiefMagic</option>
<option value="3">3rd Level, ThiefMagic</option>
<option value="4">4th Level, ThiefMagic</option>
<option value="5">5th Level, ThiefMagic</option>
<option value="6">6th Level, ThiefMagic</option>
<option value="7">7th Level, ThiefMagic</option>
<option value="8">8th Level, ThiefMagic</option>
<option value="9">9th Level, ThiefMagic</option>
<option value="10">10th Level, ThiefMagic</option>
<option value="11">11th Level, ThiefMagic</option>
<option value="12">12th Level, ThiefMagic</option>
<option value="13">13th Level, ThiefMagic</option>
<option value="14">14th Level, ThiefMagic</option>
<option value="15">15th Level, ThiefMagic</option>
<option value="16">16th Level, ThiefMagic</option>
<option value="17">17th Level, ThiefMagic</option>
<option value="18">18th Level, ThiefMagic</option>
<option value="19">19th Level, ThiefMagic</option>
<option value="20">20th Level, ThiefMagic</option>
</select>
		...
		<div class="content8">
            ...
            <br/>
                ...
                <script>
                   ...
                   $("#ThiefMagicFormV3").attr('action', "character2/basicThiefMagic.php");
